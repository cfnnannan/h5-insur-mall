<template>
  <div class="body">
    <div class="home-banner">
      <img src="@/assets/images/ean-imgs/whome-banner.png" alt="" width="100%">
    </div>
    ...
    <whomeplan id="homeplan"></whomeplan>
    <whomeintroduce id="homeintroduce"></whomeintroduce>
    <whomeflow id="homeflow"></whomeflow>
    <whomeinsure id="homeinsure"></whomeinsure>
  </div>
</template>
<script>
import utilsLogin from '@/utils/loginUtils'
import getEnv from '@/utils/getEnv'
import whomeplan from '../w-home/components/w-home-plan'
import whomeinsure from '../w-home/components/w-home-insure'
import whomeintroduce from '../w-home/components/w-home-introduce'
import whomeflow from '../w-home/components/w-home-flow'
import $ from 'jquery'
export default {
  name: 'whome',
  components: {
  ...
  methods: {
    ...
    menu() {
      ...
      if (scroll < 450) {
        this.active = 'plan'
      } else if (scroll < 1607 && scroll >= 455) {
        this.active = 'introduct'
      } else if (scroll < 2145 && scroll >= 1607) {
        this.active = 'flowpath'
      } else if (scroll >= 2145) {
        this.active = 'insure'
      }
